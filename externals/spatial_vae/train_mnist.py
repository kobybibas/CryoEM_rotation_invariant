...
def main():
    ...
    if args.dataset == 'mnist':
        ...
        mnist_train = torchvision.datasets.MNIST(osp.join(args.data_path, 'mnist'), train=True, download=True)
        mnist_test = torchvision.datasets.MNIST(osp.join(args.data_path, 'mnist'), train=False, download=True)
        ...
        mnist_train = np.load(osp.join(args.data_path, 'mnist_rotated/images_train.npy'))
        mnist_test = np.load(osp.join(args.data_path, 'mnist_rotated/images_test.npy'))

    else:
        print('# training on rotated and translated MNIST', file=sys.stderr)
        mnist_train = np.load(osp.join(args.data_path, 'mnist_rotated_translated/images_train.npy'))
        mnist_test = np.load(osp.join(args.data_path, 'mnist_rotated_translated/images_test.npy'))
