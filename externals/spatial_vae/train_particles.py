...
def main():
    ...
    parser.add_argument('--scale', default=1, type=float,
                        help='used to scale the ang/pix if images were binned (default: 1)')

    parser.add_argument('-z', '--z-dim', type=int, default=2, help='latent variable dimension (default: 2)')
    parser.add_argument('--p-hidden-dim', type=int, default=500,
                        help='dimension of hidden layers for generator (default: 500)')
    parser.add_argument('--p-num-layers', type=int, default=2,
                        help='number of hidden layers for generator (default: 2)')
    parser.add_argument('--q-hidden-dim', type=int, default=500,
                        help='dimension of hidden layers for inference net (default: 500)')
    parser.add_argument('--q-num-layers', type=int, default=2,
                        help='number of hidden layers for inference net (default: 2)')
    ...
    parser.add_argument('--expand-coords', action='store_true',
                        help='also use the second power of fthe spatial coordinates as features in the spatial generator network')
    parser.add_argument('--bilinear', action='store_true',
                        help='use bilinear layer between coordinate and latent in spatial generator network')

    parser.add_argument('--fit-noise', action='store_true',
                        help='also learn the standard deviation of the noise in the generative model')
    ...
    parser.add_argument('-c', '--crop', type=int, default=-1,
                        help='crop particles down to this size (default: -1 = unused)')
